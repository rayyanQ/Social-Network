...
if(isset($_POST['post']) === true & isset($_POST['privacy']) === true & isset($_POST['user_to']) === true){
	session_start();
	...
	$gettingUserInfo = mysqli_query($conn, "SELECT profile_pic FROM users WHERE username='$added_by'");
